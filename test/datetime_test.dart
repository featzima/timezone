...
Future<void> main() async {
  ...
  group('Constructors', () {
    ...
    test('from local DateTime', () {
      ...
      expect(newYorkTime.hour, equals(localTime.toUtc().subtract(Duration(hours: 5)).hour));
    });
    ...
    test('fromMicroseconds', () {
      final t = TZDateTime.fromMicrosecondsSinceEpoch(newYork, 1262430245006007);
      expect(t.toString(), equals('2010-01-02 06:04:05.006007-0500'));
    });
  ...
  group('Offsets', () {
    ...
    group('America/Detroit to UTC', () {
      group('EWT/EPT boundaries', () {
        ...
        final u1 = DateTime.fromMillisecondsSinceEpoch(x1.millisecondsSinceEpoch, isUtc: true);
        ...
        final u2 = DateTime.fromMillisecondsSinceEpoch(x2.millisecondsSinceEpoch, isUtc: true);
        ...
        final u3 = DateTime.fromMillisecondsSinceEpoch(x3.millisecondsSinceEpoch, isUtc: true);
        ...
        final u4 = DateTime.fromMillisecondsSinceEpoch(x4.millisecondsSinceEpoch, isUtc: true);
        ...
        final u5 = DateTime.fromMillisecondsSinceEpoch(x5.millisecondsSinceEpoch, isUtc: true);
